            ...
            <Box className='footer'>
                ...
                <Box className='bottom'>
                    <Box className="bottom_content">
                        <Typography className="bottom_title">Project</Typography>
                    ...
                    <Box className="bottom_content">
                        <Typography className="bottom_title">Community</Typography>
                    ...
                    <Box className="bottom_content">
                        <Typography className="bottom_title">Help</Typography>
